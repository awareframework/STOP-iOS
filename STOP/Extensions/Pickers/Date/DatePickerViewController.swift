...
extension UIAlertController {
    ...
    func addDatePicker(mode: UIDatePickerMode, date: Date?, minimumDate: Date? = nil, maximumDate: Date? = nil, minuteInterval: Int, action: DatePickerViewController.Action?) {
...
final class DatePickerViewController: UIViewController {
    ...
    required init(mode: UIDatePickerMode, date: Date? = nil, minimumDate: Date? = nil, maximumDate: Date? = nil, minuteInterval: Int, action: Action?) {
