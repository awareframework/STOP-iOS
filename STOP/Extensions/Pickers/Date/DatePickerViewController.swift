...
extension UIAlertController {
    ...
    func addDatePicker(mode: UIDatePicker.Mode, date: Date?, minimumDate: Date? = nil, maximumDate: Date? = nil, minuteInterval: Int, action: DatePickerViewController.Action?) {
...
final class DatePickerViewController: UIViewController {
    ...
    required init(mode: UIDatePicker.Mode, date: Date? = nil, minimumDate: Date? = nil, maximumDate: Date? = nil, minuteInterval: Int, action: Action?) {
